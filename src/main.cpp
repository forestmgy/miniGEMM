...
int main() {
    ...
    // double flops = benchmark(A, B, C, GEMM_GPU_naive);
    // std::cout << "gflops: " << flops << "\n";
    ...
    // std::cout << "start gpu tile v1: \n";
    // flops = benchmark(A, B, C, GEMM_GPU_v1);
    // std::cout << "gflops: " << flops << "\n";

    //     std::cout << "start gpu tile v3: \n";
    // flops = benchmark(A, B, C, GEMM_GPU_v3);
    // std::cout << "gflops: " << flops << "\n";

    validate_and_benchmark_reduce(2048);
}
